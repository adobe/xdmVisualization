        ...
        uglify : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/xdmVersion/<%= pkg.name %>.min.js' : [
                    ...
                    './prod/xdmVersion/lib/preinit.js' : [
                        './lib/preinit.js',
        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/xdmVersion/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
            ...
            prod : {
                ...
                files: [

                    {
                        ...
                        src : './templates/index.html',
                        dest : './prod/xdmVersion/index.html',
...

                    {
                        ...
                        src : './templates/basic.html',
                        dest : './prod/xdmVersion/basic.html',
