        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/test123/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
