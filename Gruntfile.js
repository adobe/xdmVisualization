    ...
    grunt.initConfig({
        ...
        clean : {
            ...
            prod : [
                ...
                './prod/anshchauhan_ajo-entity-fix/**/*',
        ...
        uglify : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/anshchauhan_ajo-entity-fix/<%= pkg.name %>.min.js' : [
                    ...
                    './prod/anshchauhan_ajo-entity-fix/lib/preinit.js' : [
                        './lib/preinit.js',
        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/anshchauhan_ajo-entity-fix/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
            ...
            prod : {
                ...
                files: [

                    {
                        ...
                        src : './templates/index.html',
                        dest : './prod/anshchauhan_ajo-entity-fix/index.html',
...

                    {
                        ...
                        src : './templates/basic.html',
                        dest : './prod/anshchauhan_ajo-entity-fix/basic.html',
            ...
            prod : {
                ...
                files : [

                    {
                        ...
                        dest : './prod/anshchauhan_ajo-entity-fix/',
                    ...
                    },
                    {
                        ...
                        dest : './prod/anshchauhan_ajo-entity-fix/schemas',
                    ...
                    },
                    {
                        ...
                        dest : './prod/anshchauhan_ajo-entity-fix/docs',
      ...
      'gh-pages' : {
        options: {
          base: './prod/anshchauhan_ajo-entity-fix/'
        },
        src: ['**/*']
      },
