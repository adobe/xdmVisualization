        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/hcmodels/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
