        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/hcmember/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
