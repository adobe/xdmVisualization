        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/fb/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
