        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/testjoe/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
