        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/test-123/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
