        ...
        sass : {
            ...
            prod : {
                ...
                files : {
                    ...
                    './prod/joe_demo/styles/<%= pkg.name %>.min.css' : './styles/sass/<%= pkg.name %>.scss',
