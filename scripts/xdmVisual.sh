#!/bin/bash
#usage: ./scrpts/xdmVisual.sh authToken sourceId/xdmType/metaAltId
#example: ./scripts/xdmVisual.sh ey123456789 tenant/schemas/_xdm.context.profile__union
...
metaAltId=$2
xdmname=${metaAltId////.}
./scripts/xdmQuery.sh $1 $2 > ./bower_components/mdjson-schemas/$schemabase/$xdmname.schema.json
