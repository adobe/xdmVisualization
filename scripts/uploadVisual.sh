#!/bin/bash
#usage: ./scripts/uploadVisual.sh authToken
#example: ./scripts/uploadVisual.sh ey123456789
...
for folder in ${folders[@]}; do
  ...
  for obj in $objs; do
    ...
    then
        ...
        echo "<a href = "http://xdm.corp.adobe.com/xdmVisualization/prod/$filename.html">${filename/$schemabase./}</a>" >> index.html
        echo "<br>" >> index.html
    fi
...
scp xdmVisualization.tar jwen@xdmdocs@or1010050204100.corp.adobe.com@sshp.wipc.adobe.com:/home/tomcat/webapps/xdmVisualization
ssh -t PSMConnect@sshp.wipc.adobe.com jwen xdmdocs or1010050204100.corp.adobe.com
#at this point, shell script can not be passed through cyberark
#"(cd /home/tomcat/webapps/xdmVisualization; tar -xvf xdmVisualization.tar; rm xdmVisualization.tar)"
